    ...
    <div class="row"
        ...
        <div class="col l12 xl12 s12 s12 m12 center-align">
            <ul class="tabs">
                ...
                <li class="tab col s3"><a href="dashboardLocalMin.php">PEDIDOS GENERADOS</a></li>
        ...
        foreach ($pedidos as $pedido) { ?>
            <div class="row z-depth-2 hoverable"
                ...
                <div class="col l4 m4 s12  xl4 l4">
                    <p>
                        <strong><u># <?php echo str_pad($pedido['idPedido'], 5, "0", STR_PAD_LEFT); ?></u> / <span
                                    class="text-uppercase"><?php echo $pedido['documento'] ?></span></strong>
                    </p>
                    <p>
