...
<?php foreach ($listaProductos as $producto) { ?>
    <div class="row z-depth-2 " style="border: 2px solid rgb(197, 148, 62);border-radius: 8px;margin-bottom: 15px">
        ...
        <div class="col l4 m4 s12  xl4 l4 ">
            <img class="  center-block lazy" style="width: 180px ;margin-top: 10px;margin-bottom: 10px" data-src="https://senshi.pe/tienda/img/carta/platos/<?php echo $producto['imagenProducto'] ?>" alt="">
        </div>
