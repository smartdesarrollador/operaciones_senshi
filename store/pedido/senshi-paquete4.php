...
$producto = $objProducto->getProductoById(321);
$ingredientes = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(321, 'MAKI', 'nombre');
$ingredientesSashimi = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(321, 'SASHIMI', 'posicion');
$ingredientesSushis = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(321, 'SUSHI', 'posicion');
$ingredientesGunkans = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(321, 'GUNKAN', 'posicion');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Senshi - Paquete 5</title>
                    ...
                    <form action="script/cartAction.php" method="get" id="formComprar">
                        ...
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 border border-dark rounded ">
                                ...
                                <strong class="text-info">Escoge 2 variedades de maki</strong>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 border border-dark rounded ">
                                ...
                                <strong class="text-info">Escoge 8 cortes de sashimi o 1 sashimi moriawase</strong>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 border border-dark rounded ">
                                ...
                                <strong class="text-info">Escoge 10 cortes de sushi o 1 sushi moriawase</strong>
                                <table class="table  table-sm">
                                    <thead>
                                    <tr>
...
<script>
    ...
    $('#formComprar').submit(function (event) {
        ...
        * */
        ...
        if (totalSeleccionadoMaki !== 2) {
            Swal.fire(
                'Puedes elegir como máximo 2 variedades de maki',
                '',
                'error'
            );
            infoSeleccionados = '';
        ...
        * */
        if ($('#moriawaseSashimis').prop("checked") == true) {
            ...
            if (totalSeleccionadoSashimi !== 8) {
                Swal.fire(
                    'Puedes elegir como máximo 8 variedades de sashimi o 8 sashimis de una misma variedad',
                    '',
                    'error'
                );
                infoSeleccionados = '';
       ...
       * */
        if ($('#sushiMoriawase').prop("checked") == true) {
            ...
            if (totalSeleccionadoSushis !== 10) {
                Swal.fire(
                    'Puedes elegir como máximo 10 variedades de sushis o 10 sushis de una misma variedad',
                    '',
                    'error'
                );
                infoSeleccionados = '';
