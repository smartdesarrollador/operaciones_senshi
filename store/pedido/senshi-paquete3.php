...
$producto = $objProducto->getProductoById(320);
$ingredientes = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(320, 'MAKI', 'nombre');
$ingredientesSashimi = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(320, 'SASHIMI', 'posicion');
$ingredientesSushis = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(320, 'SUSHI', 'posicion');
$ingredientesGunkans = $objProductoIngrediente->getIngredientesByIdProductoAndTipo(320, 'GUNKAN', 'posicion');
?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>Senshi - Paquete 2</title>
                    ...
                    <form action="script/cartAction.php" method="get" id="formComprar">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 border border-dark rounded ">
                                ...
                                <strong class="text-info">Escoge 4 cortes de sashimi o 1 sashimi moriawase</strong>
                                <table class="table table-sm">
                                    <thead>
                                    <tr>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-4 col-xl-4 border border-dark rounded ">
                                ...
                                <strong class="text-info">Escoge 5 cortes de sushi o 1 sushi moriawase</strong>
                                <table class="table  table-sm">
                                    <thead>
                                    <tr>
    ...
    $('#formComprar').submit(function (event) {
        ...
        * */
        ...
        if (totalSeleccionadoMaki !== 1) {
            Swal.fire(
                'Puedes elegir como máximo 1 variedad de maki',
                '',
                'error'
            );
            infoSeleccionados = '';
        ...
        * */
        if ($('#moriawaseSashimis').prop("checked") == true) {
            ...
            if (totalSeleccionadoSashimi !== 4) {
                Swal.fire(
                    'Puedes elegir como máximo 4 variedades de sashimi o 4 sashimis de una misma variedad',
                    '',
                    'error'
                );
                infoSeleccionados = '';
       ...
       * */
        if ($('#sushiMoriawase').prop("checked") == true) {
            ...
            if (totalSeleccionadoSushis !== 5) {
                Swal.fire(
                    'Puedes elegir como máximo 4 variedades de sushis o 4 sushis de una misma variedad',
                    '',
                    'error'
                );
                infoSeleccionados = '';
