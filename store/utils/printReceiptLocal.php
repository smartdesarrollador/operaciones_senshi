...
$idPedido = $_GET['order'];
$pedido = $objPedido->getPedidoLocalByID(trim($idPedido));
...
<div id="invoice-POS">
    <div id="mid">
        <div class="info">
            ...
            <p>
                ...
                Nombres: <strong><?php echo $pedido['clienteNombre'] ?></strong></br>
    ...
    <div id="bot">
                ...
                <?php foreach ($items as $item) { ?>
                    <tr class="service">
                        <td class="tableitem"><p class="itemtext">
                                ...
                                ?>
                                <br> <small >
                                    <?php echo $item['observacionesPaquete'] ?>
        ...
        <div style="font-size: 1.2em;font-weight: bolder">
            ...
            <p style="margin: 0;">
                Driver: <?php echo $pedido['driverNombre'] ?>
            </p>
