...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col l6 push-l3 pull-l3 s12 center-align z-depth-4 hoverable"
            ...
            <form id="formUpdate" class="col s12" action="https://senshi.pe/script/updateProduct.php"
                ...
                <div class="row">
                    <div class="input-field col s12">
                        <input data-min-height="499" data-max-file-size="2M" data-min-width="499"
                               ...
                               data-height="300"
                               data-default-file="https://senshi.pe/img/carta/platos/<?php echo $producto['imagenProducto'] ?>"
                    ...
                    <div class="input-field col s12 l6 xl6 m6">
                        <select required class="validate" name="tipoProducto">
                            ...
                            <?php foreach ($listaTipoProductos as $tipoProducto) { ?>
                                <option class="left"
                                        data-icon="https://senshi.pe/img/carta/categorias/<?php echo $tipoProducto['imageUrl'] ?>"
