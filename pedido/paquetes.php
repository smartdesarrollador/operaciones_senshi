...
<head>
    ...
    <link rel="stylesheet" href="../library/css/selectize.default.css">
    <script src="../library/js/selectize.js"></script>
    <style>
...
<body class="">
    ...
    <div>
        <ul id="slide-out" class="sidenav sidenav-fixed">
            <li>
                <div class="user-view">
                    ...
                    <a class="waves-effect waves-light btn">Local Lince</a>
            ...
            <li><a href="#" class="grey">Paquetes <i class="material-icons right">
                        label_important
                    </i></a></li>
        ...
        <div style="display: flex;justify-content: space-between" class="hide-on-lg-and-up">
            ...
            <ul class="tabs">
                ...
                <li class="tab col s3"><a class="red-text" style="font-weight: bolder" href="#">PAQUETES</a></li>
    ...
    <main>
        ...
        <div class="row">
            <div class="col s12" style="padding: 25px">
                <div class="row z-depth-2 flexColumn " id="ingredientesContainer" style="border: 2px solid #c23032;border-radius: 8px;margin-bottom: 15px">
                    <?php foreach ($listaProductos
                            ...
                            <div class="card white  flex-content h100">
                                ...
                                <div class="card-action mt-auto">
                                    <form class="form-plato">
                                        ...
                                        <?php if ($producto['idProducto'] == 268) {
                                        ?>
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente1">Selecciona los ingredientes</label>
                                                    <select data-cantidadIngrediente="10" id="ingrediente1" name="cars" class="browser-default selectIngredientes">
                                            ...
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente2">Selecciona los ingredientes</label>
                                                    <select data-cantidadIngrediente="10" id="ingrediente2" name="cars" class="browser-default selectIngredientes">
                                                        <option value="" selected>Selecciona un opcion</option>
                                                        <optgroup label="MAKIS">
                                                            <?php foreach ($listaMakis as $maki) { ?>
                                                                <option value="<?php echo $maki['nombre'] ?>"><?php echo $maki['nombre'] ?></option>
                                        ...
                                        <?php if ($producto['idProducto'] == 269) {
                                        ?>
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente3">Selecciona los ingredientes</label>
                                                    <select data-cantidadIngrediente="10" id="ingrediente3" name="cars" class="browser-default selectIngredientes">
                                                        <option value="" selected>Selecciona un opcion</option>
                                                        <optgroup label="MAKIS">
                                                            <?php foreach ($listaMakis as $maki) { ?>
                                                                <option value="<?php echo $maki['nombre'] ?>"><?php echo $maki['nombre'] ?></option>
                                            ...
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente4">Selecciona los ingredientes</label>
                                                    <select data-cantidadIngrediente="10" id="ingrediente4" name="cars" class="browser-default selectIngredientes">
                                                        <option value="" selected>Selecciona un opcion</option>
                                                        <optgroup label="MAKIS">
                                                            <?php foreach ($listaMakis as $maki) { ?>
                                                                <option value="<?php echo $maki['nombre'] ?>"><?php echo $maki['nombre'] ?></option>
                                            ...
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente5">Selecciona los ingredientes</label>
                                                    <select data-cantidadIngrediente="10" id="ingrediente5" name="cars" class="browser-default selectIngredientes">
                                                        <option value="" selected>Selecciona un opcion</option>
                                                        <optgroup label="MAKIS">
                                                            <?php foreach ($listaMakis as $maki) { ?>
                                                                <option value="<?php echo $maki['nombre'] ?>"><?php echo $maki['nombre'] ?></option>
                                            ...
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente6">Selecciona los ingredientes</label>
                                                    <select data-cantidadIngrediente="10" id="ingrediente6" name="cars" class="browser-default selectIngredientes">
                                                        <option value="" selected>Selecciona un opcion</option>
                                                        <optgroup label="MAKIS">
                                                            <?php foreach ($listaMakis as $maki) { ?>
                                                                <option value="<?php echo $maki['nombre'] ?>"><?php echo $maki['nombre'] ?></option>
                                        ...
                                        <?php if ($producto['idProducto'] == 370) {
                                        ?>
                                            <div class="row ">
                                                <div class="col s4">
                                                    <label for="ingrediente3">Selecciona los ingredientes</label>
                                        ...
                                        <?php if ($producto['idProducto'] == 268 || $producto['idProducto'] == 269 || $producto['idProducto'] == 370) {
                                            $idObservaciones = uniqid();
                                        ?>
                                            <div class="row">
                                                <div class="input-field col s12">
                                                    <input placeholder="OBSERVACIONES" id="<?php echo $idObservaciones ?>" type="text" class="observacionesPaquete">
                                                    <label for="<?php echo $idObservaciones ?>">OBSERVACIONES</label>
                                                </div>
                                            ...
                                            <div class="row" style="margin-top: 15px">
                                                ...
                                                <div class="col s12 center-align">
                                                    ...
                                                    <input class="idProducto" type="hidden" name="id" value="<?php echo $producto['idProducto'] ?>">

                                                    <div class="" style="margin-top: 15px">
                                                        <button onclick="changeQty(this,'minus')" class="btn btn-small btn-flat grey" type="button">
                                                            <i class="material-icons">remove</i>
                                                        </button>
                                                        <input style="width: 30%;" required onkeypress="return solonumeros(event);" type="number" minlength="1" class="cantidad center-align " min="1" name="cantidad" value="1" placeholder="Cantidad">
                                                        <button onclick="changeQty(this,'add')" type="button" class="btn btn-small btn-flat grey">
                                            ...
                                            <?php } else {
                                            if ($producto['productoObservaciones'] == 'MULTI_PAQUETE1') { ?>
                                                <a href="senshi-paquete1.php" class="btn btn4 btn-lg " style="font-size:1.3rem;font-weight:bold">
                                                    <i class="fas fa-shopping-cart mr-1"></i>Comprar
                                                </a>
                                            <?php } elseif ($producto['productoObservaciones'] == 'MULTI_PAQUETE2') { ?>
                                                <a href="senshi-paquete2.php" class="btn btn4 btn-lg " style="font-size:1.3rem;font-weight:bold">
                                                    <i class="fas fa-shopping-cart mr-1"></i>Comprar
                                                </a>
                                            <?php } elseif ($producto['productoObservaciones'] == 'MULTI_PAQUETE3') { ?>
                                                <a href="senshi-paquete3.php" class="btn btn4 btn-lg " style="font-size:1.3rem;font-weight:bold">
                                                    <i class="fas fa-shopping-cart mr-1"></i>Comprar
                                                </a>
                                            <?php } elseif ($producto['productoObservaciones'] == 'MULTI_PAQUETE4') { ?>
                                                <a href="senshi-paquete4.php" class="btn btn4 btn-lg " style="font-size:1.3rem;font-weight:bold">
                                                    <i class="fas fa-shopping-cart mr-1"></i>Comprar
                                                </a>
                                            <?php } elseif ($producto['productoObservaciones'] == 'MULTI_PAQUETE5') { ?>
                                                <a href="senshi-paquete5.php" class="btn btn4 btn-lg " style="font-size:1.3rem;font-weight:bold">
                                                    <i class="fas fa-shopping-cart mr-1"></i>Comprar
                                                </a>
                                            <?php } else { ?>
        ...
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <form action="script/checkout.php" class="col s12" method="post" id="formGenerarPedidoDelivery">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input placeholder="" required name="nombre" id="nombreDelivery" type="text" class="validate">
                    ...
                    <div class="row">
                        <div class="input-field col s6">
                            <input name="correo" id="correoDelivery" type="text" class="validate correoAConsultar">
                            <label for="correoDelivery">Correo</label>
                            <a class="btn btn-flat" onclick="buscarUsuario(this)"><i class="material-icons">search</i></a>
                        </div>
                        <div class="input-field col s6">
    ...
    <script>
        async function buscarUsuario(element) {
            let correo = element.parentElement.querySelector('.correoAConsultar').value;
            let cliente = await buscarUsuarioFetch(correo);

            let nombreDelivery = document.getElementById('nombreDelivery');
            nombreDelivery.value = cliente.nombre;
            console.log(cliente);
        }

        function buscarUsuarioFetch(email) {
            return fetch('./api/obtenerClientesPorCorreo.php?email=' + email)
    ...
    <script>
        $('.form-plato').submit(function(event) {
            ...
            let observacionesPaquete = form.querySelector('.observacionesPaquete').value;
            let data = new FormData();


            let ingredientesElement = form.getElementsByTagName('select');


            let infoSeleccionados = '';
            for (let index = 0; index < ingredientesElement.length; ++index) {
                infoSeleccionados += ingredientesElement[index].value + ` (X${ingredientesElement[index].getAttribute('data-cantidadIngrediente')})` + ', ';
            }
