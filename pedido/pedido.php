...
<body class="">
    ...
    <div>
        <ul id="slide-out" class="sidenav sidenav-fixed">
            <li>
                <div class="user-view">
                    ...
                    <a href="#" class="btn btn-danger">Local Lince</a>
            ...
            <li><a href="#!" class="grey">Platos <i class="material-icons right">
                        label_important
                    </i></a></li>
        ...
        <div style="display: flex;justify-content: space-between" class="hide-on-lg-and-up">
            ...
            <ul class="tabs">
                <li class="tab col s3"><a class="red-text" style="font-weight: bolder" href="#">PLATOS</a></li>
                <li class="tab col s3"><a href="paquetes">PAQUETES</a></li>
                <li class="tab col s3"><a href="sushi" style="font-weight: bolder">SUSHI</a></li>
            </ul>
        ...
        <div class="col s12">
            <div class="row">
                <div class="input-field col s12 m6 xl8 l8">
                    <input autocomplete="off" placeholder="BUSCAR PLATO" id="caja_busqueda" type="text"
                           class="validate">
                </div>
                    ...
                    <div class="input-field col s12 m6 xl8 l8">
                        <form autocomplete="off" action="/action_page.php">
                            <div class="autocomplete" style="width: 100%">
                                <input style="width: 100%" id="myInput" type="text" name="myCountry" placeholder="BUSQUEDA RÁPIDA">
                            </div>

                        </form>
                    </div>
                    <div class="input-field col s12 m6 xl4 l4">
                        <input placeholder="Cantidad" value="1" min="1" minlength="1" id="cantidadCompraRapida" type="number" class="validate">
                        <label for="cantidadCompraRapida">CANTIDAD</label>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div id="carrito" class="modal">
        <div class="modal-content">
            ...
            <div class="row">
                ...
                <form action="script/checkout.php" class="col s12" method="post" id="formGenerarPedidoRecojo" onsubmit="return checkSubmit();">
                ...
                <form action="script/checkout.php" class="col s12" method="post" id="formGenerarPedidoDelivery" onsubmit="return checkSubmit();">
    ...
    <script>
        function anadirAlCarrito(id, cantidad) {
            ...
            fetch('script/cartAction.php', {
                ...
                window.location.href = 'pedido?code=success';
        ...
        $(document).ready(function() {
            ...
            $(function() {
                $.ajax({
                    type: 'GET',
                    url: 'api/getPlatosNormales.php',
                    success: function(response) {
                        let platoArray = response.data;
                        let dataPlato = {};
                        let dataTest = [];
                        for (let i = 0; i < platoArray.length; i++) {

                            dataPlato[platoArray[i].nombreProducto] = null;
                        }
        ...
        function autocomplete(inp, arr) {
            ...
            inp.addEventListener("input", function(e) {
                ...
                for (i = 0; i < arr.length; i++) {
                    ...
                    if (arr[i].nombreProducto.substr(0, val.length).toUpperCase() == val.toUpperCase()) {
                        /*create a DIV element for each matching element:*/
                        b = document.createElement("DIV");
                        /*make the matching letters bold:*/
                        b.innerHTML = "<strong>" + arr[i].nombreProducto.substr(0, val.length) + "</strong>";
                        b.innerHTML += arr[i].nombreProducto.substr(val.length);
                        /*insert a input field that will hold the current array item's value:*/
                        b.innerHTML += "<input type='hidden' value='" + arr[i].idProducto + "'>";
                        /*execute a function when someone clicks on the item value (DIV element):*/
                        b.addEventListener("click", function(e) {
                            /*insert the value for the autocomplete text field:*/


                            let idProducto = this.getElementsByTagName("input")[0].value;
                            let cantidad = document.getElementById('cantidadCompraRapida').value;
                            inp.value = idProducto;


                            anadirAlCarrito(idProducto, cantidad);
                            /*   window.location = 'script/cartAction.php?action=addToCart&id=' + idProducto + '&cantidad=' + cantidad;
                             */
