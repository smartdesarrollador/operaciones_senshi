...
if (isset($_GET['date'])) {
    ...
    $pedidos = $objPedido->getPedidosByDriverAndFechaPedido($id, $selectedDate);

} else {
    $pedidos = $objPedido->getPedidosByDriver($id);
}
$precioTotal = 0;
...
<div class="container">
    <div class="row">
        <div class="col s12">
            <ul class="tabs">
                <li class="tab col s6"><a class="active" href="#">WEB</a></li>
                <li class="tab col s6"><a href="driverLocal?id=<?php echo $id ?>">WHATSAPP</a></li>
...
<script>
    function filtrar(value) {
        ...
        if (value == 3) {
            window.location = `driver?id=<?php echo $id ?>`
    ...
    $(document).ready(function () {
        ...
        $('.datepicker').datepicker({
            ...
            onSelect: function (date) {
                ...
                window.location = `driver?date=${fechaActual}&id=<?php echo $id ?>`
